...
if(TARGET avif)
    ...
    # If AVIF_LIBRARY is a shared Windows library, we should link the import library
    if("${AVIF_LIBRARY}" MATCHES ".*\\.dll$")
        GET_TARGET_PROPERTY(AVIF_LIBRARY avif IMPORTED_IMPLIB)
    endif()
